...
class Mapa{
    ...
    public:
        ...
        void Plot1(int& persol, int& persoc, bool& botao, bool& chave, bool &fechadura);
};
...
int main(){
    ...
    while(synth.vida>=0 and mapa1.fim==false){
        ...
        mapa1.Plot1(synth.l,synth.c,synth.botao, synth.chave, synth.fechadura);
...
void Mapa::Plot1(int& persol, int& persoc, bool& botao, bool& chave, bool &fechadura){
...
void Personagem::Movimento(Mapa& mapa){
	...
	system("color 02");
    cout<<"VIDAS: "<<vida<<" BOTAO: "<<botao<<" CHAVE: "<<chave<<" FECHADURA: "<<fechadura<<endl;
    cout<<">";
    cin>>comando;
    ...
    switch(comando){
        ...
        case 'i':
        	...
        	if((mapa.mapa[l-1][c]=='|' or mapa.mapa[l+1][c]=='|' or mapa.mapa[l][c-1]=='|' or mapa.mapa[l][c+1]=='|') and chave==true){
        		fechadura=true;
        	}
        	break;
    }
