...
int main(){
    ...
    do{
        ...
        if(escolha==49){
        	...
        	//PONTO DE CHECAGEM DE VIDA
        	if(synth.vida!=0 and mapa.fim==2){
        		Reboot_only(mapa);
        	...
        	//PONTO DE CHECAGEM DE VIDA
        	if(synth.vida!=0 and mapa.fim==3){
        		Reboot_only(mapa);
	...
	for(l=0;l<75;l++){
		...
		for(c=0;c<75;c++){
			...
			*/
			...
			//TERMINAL 1
			else if(l==15 and c==59 and terminal==4){
				mapa[l][c]='0';
               	cout<<mapa[l][c]<<" ";
			}
			
			//TERMINAL 2
			else if(l==5 and c==17 and terminal>=3){
				mapa[l][c]='0';
               	cout<<mapa[l][c]<<" ";
			}
			
			//TERMINAL 3
			else if(l==69 and c==59 and terminal>=2){
				mapa[l][c]='0';
               	cout<<mapa[l][c]<<" ";
			}
			...
			//SALA INFERIOR ESQUERDA
				...
				if(fechadura==false or terminal>=2){
					mapa[l][c]='D';
                	cout<<mapa[l][c]<<" ";
				}
...
void Dialogo(int dialogo){
	...
	//DIALOGO FINAL
		...
		system("pause");
	   	...
	   	cout<<"\t\t\t\t\t\t                   \"ROGUE ANDROIDE DECONTAMINATION ENGINEER\"                   "<<endl;
	   	cout<<"\t\t\t\t\t\t                                                                                 "<<endl;
