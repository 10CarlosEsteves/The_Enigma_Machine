...
int main(){
    ...
    do{
        ...
        if(escolha==1){
            cout<<"\t\t\t\tBem vindo ao modo campanha"<<endl;
            sleep(2);
            ...
            cout<<"\t\t\t\tBem vindo ao modo tutorial, dentro alguns segundos voce jogara o nosso jogo..."<<endl;
            sleep(1);
            
            //União Mapa-Personagem Tutorial
